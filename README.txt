...
J1 CPU is a 16-bit stack machine.  The instructions are 16 bits in length, and other than jumps and literal loads, look like VLIW instructions.  The bits control transfers and stack pointer modifications.  Since there are few registers in a stack machine, 12 bits control the entire machine.  The instruction set is very flexible, and many instructions map closely onto Forth primitives.
